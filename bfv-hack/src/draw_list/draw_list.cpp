...
//void CDrawing::AddCircle3D(Vector position, Matrix4x4 matrix, float points, float radius, ImColor& color)
//{
...
//
//		if (!game_utils::world_to_screen(matrix, start, start2d) || !game_utils::world_to_screen(matrix, end, end2d))
//			return;
//
